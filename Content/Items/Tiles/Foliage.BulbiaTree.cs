...
class BulbiaTree : ModTile
{
    ...
    public override void SetStaticDefaults() => QuickTile.QuickFoliageTile(this, DustID.IceTorch, SoundID.Grass, false, 3, 3, new int[] { 16, 16, 16 }, true, 1, ModContent.TileType<AbyssalGrassTile>(), new Point16(1, 1));
