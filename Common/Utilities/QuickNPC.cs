...
public enum WormSegmentType { Head, Body, Tail }
...
public abstract class WormBody : Worm
{
	...
	internal override void BodyTailAI() => CommonAI_BodyTail(this);
...
public abstract class WormTail : Worm
{
	...
	internal override void BodyTailAI() => WormBody.CommonAI_BodyTail(this);
}