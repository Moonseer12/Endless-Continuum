...
abstract class QuickNPC
{
	...
	public static void QuickEnemyNPC(ModNPC npc, Vector2 size, int life, int damage, int defense, float kbresist, SoundStyle hit, SoundStyle death, int aiStyle, int slot, bool gravity, int value)
	{
		npc.NPC.Size = size;
		npc.NPC.lifeMax = life;
		npc.NPC.damage = damage;
